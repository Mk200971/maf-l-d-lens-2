...
interface FiltersContextValue {
  ...
  toggle: (key: 'years' | 'bus' | 'countries' | 'roles' | 'programs' | 'sessionIds', value: string | number) => void
...
export function FiltersProvider({ children }: { children: React.ReactNode }) {
  ...
  const toggle = useCallback(
    (key: 'years' | 'bus' | 'countries' | 'roles' | 'programs' | 'sessionIds', value: string | number) => {
      setFilters((prev) => {
