...
const PLACEHOLDERS = [
  ...
  "Filter by business unit or country",
  "Compare completion rates across programs",
  "What's the average satisfaction score?",
  "Show NPS trends by role",
  "Analyze feedback volume this year",
]
        ...
        <div className="flex flex-col items-stretch w-full h-full">
          ...
          <div className="flex items-center gap-2 p-3 rounded-full bg-white max-w-3xl w-full">
            ...
            <div className="relative flex-1">
              <input
                ...
                className="flex-1 border-0 outline-0 rounded-md py-2 text-base bg-transparent w-full font-normal text-gray-900 placeholder-transparent"
            ...
            <button
              className="flex items-center gap-1 bg-black hover:bg-zinc-700 disabled:bg-zinc-400 disabled:cursor-not-allowed text-white p-3 rounded-full font-medium justify-center transition-colors"
              title="Send"
              type="button"
              tabIndex={-1}
          ...
          >
            <div className="flex gap-3 items-center">
              {/* Think Toggle */}
              <button
                className={`flex items-center gap-1 px-4 py-2 rounded-full transition-all font-medium group disabled:opacity-50 disabled:cursor-not-allowed ${
                  thinkActive
